            ...
            <div>
                <v-simple-table dark color="indigo lighten-4">
                    <template v-slot:default>
                        ...
                        <tbody>
                            <tr v-for="ride in rides" :key="ride.rideId">
                                ...
                                <td class="text-center">
                                    ...
                                    <v-btn @click="deleteRow(ride.rideId)" color="orange darken-4" fab small>
                                        <v-icon>cancel</v-icon></v-btn>

                                    <v-btn @click="rideId=ride.rideId" color="blue" :to="{name:'UpdateRide', params:{rideId:ride.rideId}}" fab small><v-icon>edit</v-icon></v-btn>
                                </td>
                            </tr>
                        </tbody>
                    </template>
...
export default {
    data() {
        return {
            ...
            message:'',
            headers: [
                { text: 'Ride Name', align: 'center', value: 'rideName' },
                { text: 'Booked_date', align: 'center', value: 'bookedDate' },
                { text: 'Cost', value: 'price', align: 'center' },
                { text: 'Num Of Persons', value: 'numOfPersons', align: 'center' },
